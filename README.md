...
> - обновил данные `UserMealsUtil.userMeals` и переименовал некоторые пременные, поля и методы
...
- через Stream API за 1 проход по исходному списку `userMeals.streem()`
